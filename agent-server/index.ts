...
interface IncomingMessage {
  type: 'send' | 'stop' | 'ping' | 'resolve_permission' | 'resolve_picker' | 'get_capabilities' | 'store_credential' | 'clear_credential' | 'clear_context' | 'read_task_output' | 'stop_task' | 'app_tool_result';
  provider?: Provider;
  /**
