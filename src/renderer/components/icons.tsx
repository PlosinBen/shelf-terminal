...
// Plug — MCP (external servers that "plug into" the agent). The two prongs +
// the body read as a connector at 14px without crowding the line-icon row.
export function McpIcon({ size }: IconProps) {
  return (
    <Svg size={size}>
      <path d="M12 22v-5" />
      <path d="M9 8V2" />
