...
// both agents, run on whichever machine the agent runs on. Additive on top of the
// agent's native config — see features/app-level-mcps. The CRUD here is unchanged
