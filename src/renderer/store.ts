...
export interface AgentTabState {
  ...
  capabilities: { models: { value: string; displayName: string; effortLevels?: string[]; vision?: boolean }[]; permissionModes: string[]; effortLevels: string[]; authMethod?: import('@shared/types').AuthMethod } | null;
