...
| Worktree lifecycle | [worktree](worktree.md) | create/finish proposal gates, note hand-off, provider override |
| Project collection / reorder | [projects](projects.md) | stable mounted-view order、project-id targets、array-backed readonly project boundary |
